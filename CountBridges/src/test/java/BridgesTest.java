...
public class BridgesTest {
    ...
    void bridges1() throws FileNotFoundException{
        ...
        assertThat(countBridges.execute(testGraph)).isEqualTo(1);
    }
    @Test
    void bridges2() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(8);
    }
    @Test
    void bridges3() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(3);
    }
    ...
    void bridges4() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(6);
    }
    ...
    void bridges5() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(5);
    }
    ...
    void bridges6() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(10);
    }
    ...
    void bridges7() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(2);
    }
    ...
    void bridges9() throws FileNotFoundException{
        ...
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(0);
    }
    ...
    @Test
    void bridges11() throws FileNotFoundException{
        Graph testGraph = GraphFactory.loadGraphFromFile(new File("src/test/resources/graph.txt"));
        CountBridges countBridges = new CountBridges();
        assertThat(countBridges.execute(testGraph)).isEqualTo(0);
    }
}